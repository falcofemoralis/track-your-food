...
export default AddFoodScreen = props => {
        ...
        <View style={styles.container}>
            <View style={styles.main}>
                <Pressable onPress={photoHandler} style={styles.image} >
                    {
                        image ? <Image source={{ uri: image }} style={styles.image} /> : <Image source={require('../../assets/noimage.png')} style={styles.image} />
                    }
                </Pressable>
                <View>
